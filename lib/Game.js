...
module.exports = class Game {
  ...
  animate() {
    ...
    this.blocks.forEach( block => {
      ...
      const bluePath = block.path.filter(pathUnit => pathUnit.color === 'cornflowerblue');

      const orangePath = block.path.filter(pathUnit => pathUnit.color === 'orange');
  ...
  handleBlock(block, pathUnit) {
    ...
    //   this.endGame();
    } else if(block.isCollidingWithPath(this.path)){
